...
public interface IService<T> {
    ...
    <R> List<R> find(T model, Class<R> clazz);

//    <R, REQUEST extends AbstractRequest> RestPage<R> withPage(Class<R> clazz, REQUEST request, String... needField);
//
//    <R, REQUEST extends AbstractRequest> List<R> findByRequest(Class<R> clazz, REQUEST request, String... needField);
//
//    <REQUEST extends AbstractRequest> Example commonRequest(REQUEST request, String[] needField);

    <R> R findById(Class<R> clazz, long id);
